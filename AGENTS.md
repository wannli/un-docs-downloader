...
**During merges:**
- When merging branches, `docs/` files will have conflicts because both branches regenerated the site.
- **Always resolve docs/ conflicts by taking "ours"** (keep your branch's version): `git checkout --ours docs/`
